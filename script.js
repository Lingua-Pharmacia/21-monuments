...
let lifetimeScore = parseInt(localStorage.getItem('monumentsScore')) || 0;
let completedLessons = JSON.parse(localStorage.getItem('completedMonumentsLessons')) || [];
if(ptsVal) ptsVal.innerText = lifetimeScore;

let wordBucket = []; let currentQ = 0; let attempts = 0; let totalScore = 0; let firstCard = null;

const stations = [
    {file:"01_GreatPyramid.mp3", title:"1. The Great Pyramid of Giza"},
    {file:"02_GreatWall.mp3", title:"2. The Great Wall of China"},
    {file:"03_TajMahal.mp3", title:"3. The Taj Mahal"},
    {file:"04_Colosseum.mp3", title:"4. The Colosseum"},
    {file:"05_MachuPicchu.mp3", title:"5. Machu Picchu"},
    {file:"06_Acropolis.mp3", title:"6. The Acropolis of Athens"},
    {file:"07_Petra.mp3", title:"7. Petra"},
    {file:"08_ChichenItza.mp3", title:"8. Chichén Itzá"},
    {file:"09_Stonehenge.mp3", title:"9. Stonehenge"},
    {file:"10_HagiaSophia.mp3", title:"10. Hagia Sophia"},
    {file:"11_EiffelTower.mp3", title:"11. The Eiffel Tower"},
    {file:"12_AngkorWat.mp3", title:"12. Angkor Wat"},
    {file:"13_Alhambra.mp3", title:"13. The Alhambra"},
    {file:"14_Versailles.mp3", title:"14. Palace of Versailles"},
    {file:"15_ForbiddenCity.mp3", title:"15. The Forbidden City"},
    {file:"16_GreatSphinx.mp3", title:"16. The Great Sphinx of Giza"},
    {file:"17_StatueOfLiberty.mp3", title:"17. The Statue of Liberty"},
    {file:"18_ChristRedeemer.mp3", title:"18. Christ the Redeemer"},
    {file:"19_Moai.mp3", title:"19. Moai of Easter Island"},
    {file:"20_Pantheon.mp3", title:"20. The Pantheon"},
    {file:"21_Neuschwanstein.mp3", title:"21. Neuschwanstein Castle"}
];
...
function finishQuiz() {
    lifetimeScore += totalScore; localStorage.setItem('monumentsScore', lifetimeScore);
    const fn = decodeURIComponent(audio.src.split('/').pop());
    if(!completedLessons.includes(fn)) { 
        completedLessons.push(fn); 
        localStorage.setItem('completedMonumentsLessons', JSON.stringify(completedLessons)); 
    }
    renderGrid(); 
